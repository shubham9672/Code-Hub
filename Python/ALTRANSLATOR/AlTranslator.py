...
class AlTranslator():
    ...
    def __init__(self):
        ...
        titleLabel = Label(titleBar, text='ALTRANSLATOR', fg='#909090', bg='#141414', font=appHighlightFont)
        ...
        inputText = Text(root,font = appHighlightFont, height = 11, wrap = WORD, padx=5, pady=5, width=40, fg='#4877bc')
        inputText.place(x=20, y=100)
        outputText = Text(root,font = appHighlightFont, height = 11, wrap = WORD, padx=5, pady= 5, width=40, bg='#f8f9fb',fg='#4877bc')
