...
def Delete():
    if len(contactNo1Var.get()) == 0 and len(nameVar.get()) == 0:
        ...
        messagebox.showinfo(
            "Contact Management System", "Contact deleted successfully !"
        )
        clear()
        display()
...
heading = Label(
    headFrame, text="CONTACT BOOK", font="mssanserif 30 bold", bg="#001133", fg="white"
)
...
# Labels
contactType_Lbl = Label(
    leftFrame, text="Contact Type : ", font="verdana 15 bold", bg="#001133", fg="white"
)
contactType_Lbl.place(x=10, y=60)
contactNo1_Lbl = Label(
    leftFrame, text="Contact No. : ", font="verdana 15 bold", bg="#001133", fg="white"
)
contactNo1_Lbl.place(x=10, y=110)
name_Lbl = Label(
    leftFrame, text="Name : ", font="verdana 15 bold", bg="#001133", fg="white"
)
name_Lbl.place(x=10, y=160)
city_Lbl = Label(
    leftFrame, text="City : ", font="verdana 15 bold", bg="#001133", fg="white"
)
city_Lbl.place(x=10, y=210)
address_Lbl = Label(
    leftFrame, text="Address : ", font="verdana 15 bold", bg="#001133", fg="white"
)
address_Lbl.place(x=10, y=260)
email_Lbl = Label(
    leftFrame, text="Email : ", font="verdana 15 bold", bg="#001133", fg="white"
)
...
E_name = Entry(
    leftFrame, textvar=nameVar, font="verdana 14 bold", width=17, bd=2, relief=RAISED
)
E_name.place(x=200, y=160)
E_city = Entry(
    leftFrame, textvar=cityVar, font="verdana 14 bold", width=17, bd=2, relief=RAISED
)
E_city.place(x=200, y=210)
E_address = Entry(
    leftFrame, textvar=addressVar, font="verdana 14 bold", width=17, bd=2, relief=RAISED
)
E_address.place(x=200, y=260)
E_email = Entry(
    leftFrame, textvar=emailVar, font="verdana 14 bold", width=17, bd=2, relief=RAISED
)
...
data_listBox = ttk.Treeview(
    rightFrame,
    height=17,
    columns=("ContactType", "ContactNo", "Name", "City", "Address", "Email"),
...
noContacts_Lbl = Label(
    root, text="NO CONTACTS", font="mssanserif 16 bold", fg="white", bg="#00091a"
)
